...
function Profile({ 
  name = "Dusty Tessini", 
  summary = "Descripción profesional breve que destaque tus principales habilidades y experiencia.",
  ...
  useEffect(() => {
    const fetchLanguages = async () => {
      try {
        ...
        // Extraer lenguajes únicos de todos los repositorios
        ...
        // Fallback a lenguajes por defecto si falla la API
        setLanguages(["JavaScript", "React", "TypeScript", "Node.js", "Python", "CSS"])
      } finally {
        setLoading(false)
      }
    }
    ...
    <div className="profile">
      <div className="profile-content">
        ...
        <div className="profile-languages">
          <h3 className="languages-title">Tecnologías</h3>
          <div className="languages-list">
            {loading ? (
              <span className="language-tag loading">Cargando...</span>
            ) : (
        ...
        <div className="profile-social">
          <div className="social-links">
            ...
            {socialLinks.facebook && (
              <a href={socialLinks.facebook} target="_blank" rel="noopener noreferrer" className="social-link" title="Facebook">
                <svg className="social-icon" viewBox="0 0 24 24" fill="currentColor">
            ...
            {socialLinks.email && (
              <a href={socialLinks.email} className="social-link" title="Email">
                <svg className="social-icon" viewBox="0 0 24 24" fill="currentColor">
